...
export const masteryStandard = [
  ...
  "- قبل الكتابة حدّد داخلياً: من الجمهour؟ ما القرار المطلوب منه؟ ما العائق الحقيقي؟ ما المؤشر الذي سيتحسّن؟ ثم اكتب المخرج الذي يحرّك هذا المؤشر — لا الذي يبدو جميلاً فقط.",
