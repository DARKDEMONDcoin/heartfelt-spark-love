...
const versus = [
  ...
  { q: "الإعلانات وإدارتها", chat: "تنسخ نص الإعلان وتدير الحملة بنفسك", sahl: "موظف متخصص لبناء الإعلانات وإدارتها — يشغّله صاحب أفضل شركة تسويق وترجمة في مصر، بخبرة الأفضل لكل مجال وشخص" },
